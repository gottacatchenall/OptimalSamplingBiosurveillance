...
The field of biodiversity monitoring has established many practices and tools that can directly inform biosurveillance efforts @Poisot2025BiodiversityScience. 

*TK: add reference to other long-term monitoring stuff* #sidenote()[R1, C3]
...
*TK paragraph on logistics and funding #sidenote()[R1 C2]*. GBiOS paper and UN coalition funding model, similar to SOFF for GCOS. Confederated system for disease surveillance that builds on existing long-term biodiversity monitoring programs, LTER, NEON, etc. 
