...
*TK address reviewer 2 comment about sampling size and its relation to prevalence uncertainty*
...
*TK expand on discussion, match tone to introduction. More citations "less selectively chosen"* #sidenote()[R1 C6]

*TK open with more background on the relationship between biogeography and zoonotic pathogens, why good surveillance is important for public health, and how this protocol addresses this*
...
Better biosurveillance itself is not #add[sufficient to prevent] spillover #cut[prevention], but it’s a necessary #change[pillar] #cut[of it] to make prevention possible --- it’s the best we can do in the context of limited information on #add[pathogen] prevalence --- but a full approach to prevention of zoonotic spillover is broader than this alone @Ramakrishnan2023BiosurveillanceOne. This protocol represents a necessary #change[next]#sidenote[R1 L438] step toward #add[integrating] #cut[widespread] biosurveillance #cut[integrated ] with global#add[, long-term] biodiversity monitoring systems @Gonzalez2023GlobalBiodiversity to ensure a just planetary future @Chapman2024BiodiversityMonitoring. 
