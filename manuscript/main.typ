...
#show heading: it => {
  text(it.body, size: 0.87em,font: "Helvetica Neue", weight: 500, fill: rgb("#2e5385"))
  v(-0.3em)
}
#show heading.where(level: 2): it =>{
    text(it.body, size:0.85em, font: "Helvetica Neue", style: "italic", weight: 400, fill: rgb("#1d8265")) 
    v(-0.2em)
}

#show cite: set text(fill: rgb("#528fd1"))

*Keywords*: disease ecology, One Health, biosurveillance, biodiversity monitoring
...
*Acknowledgements*: MDC was funded through an IVADO postdoctoral fellowship. TP was funded by the Wellcome Trust (223764/Z/21/Z); CBB, CJC, RG, HR, DS, SS, and TP were supported by the US National Science Foundation (grant no. DBI 2213854). AB was funded by the CANOPY CIHR training program. CBB was supported by an NSERC PGSD (no. 56749). HR was funded by an NSF GRFP (grant no. DGE-2139841). RG was supported by the Wolfson Foundation, via a UCL Excellence Fellowship. BK was funded by CIHR DRA (BCB 201224). DS was funded by a joint NSF‐NIH‐NIFA EEID Award \#2208034
]
